...
func TestEncode2(t *testing.T) {
	for _, item := range []struct {
	...
	}{
		{
			...
			unpacked:     "3132333435363761686966626577696261696F776E6665",
			packedString: "31D98C56B3DDC2E8B4595CBEA7C5E1F4FBEE36971B",
		},
		{
			name:         "短短信-7位",
			content:      "1234567",
			unpacked:     "31323334353637",
			packedString: "31D98C56B3DD1A",
		},
		{
			name:         "短短信-有escape",
			content:      "[1234a][1234a][1234a][1234a][1234a][1234a][1234a]",
			unpacked:     "1B3C31323334611B3E1B3C31323334611B3E1B3C31323334611B3E1B3C31323334611B3E1B3C31323334611B3E1B3C31323334611B3E1B3C31323334611B3E",
			packedString: "1B5E4C36A38537BE0D2F269BD1C21BDF861793CD68E18D6FC38BC966B4F0C6B7E1C564335A78E3DBF062B2192DBCF16D7831D98C16DEF81A",
		},
		{
			name:         "长短信-无escape", // 长度 161
			content:      "1234567ahifbewibaiownfe1234567ahifbewibaiownfe1234567ahifbewibaiownfe1234567ahifbewibaiownfe1234567ahifbewibaiownfe1234567ahifbewibaiownfe1234567ahifbewibaiownfe",
			unpacked:     "",
			packedString: "",
		},
	} {
		unpacked, err := Encode(item.content)
		if err != nil {
			t.Fatalf("%s encode error: %v", item.name, err)
		}

		assert.Equal(t, item.unpacked, hexString(unpacked))

		packed := Pack(unpacked)
		assert.Equal(t, item.packedString, hexString(packed))

		unpacked1 := Unpack(packed)
		assert.Equal(t, unpacked, unpacked1)

		src, err := Decode(unpacked1)
		if err != nil {
			t.Fatalf("%s decode error: %v", item.name, err)
		}
		assert.Equal(t, item.content, string(src))
	}
}
