...
const (
	...
	ESME_RINVREGDLVFLG    CMDStatus = 0x00000007 // Invalid Registered CMPPDelivery Flag
	...
	ESME_RINVSCHED        CMDStatus = 0x00000061 // Invalid IsScheduled CMPPDelivery Time
	...
	ESME_RDELIVERYFAILURE CMDStatus = 0x000000FE // CMPPDelivery Failure (used for data_sm_resp)
...
const (
	...
	// 用于判断Address类型
	TON_Unknown          = 0x00 // 未知场景
	TON_International    = 0x01 // 国际手机号，以 + 开头
	TON_National         = 0x02
	TON_NetworkSpecific  = 0x03 // Short Code. 企业简称
	TON_SubscriberNumber = 0x04
	TON_Alphanumeric     = 0x05 // alphanumeric or non-numeric
	TON_Abbreviated      = 0x06 // 缩略语，简称，SenderID 场景
)
