...
func (d *Deliver) IEncode() ([]byte, error) {
	...
	b.WriteFixedLenStringField("RecvTime", d.RecvTime, 14)
	b.WriteFixedLenStringField("SrcTermID", d.SrcTermID, 21)
	b.WriteFixedLenStringField("DestTermID", d.DestTermID, 21)
	b.WriteUint8(d.MsgLength)
	b.WriteBytes(d.MsgContent)
	b.WriteFixedLenStringField("Reserve", d.Reserve, 8)
