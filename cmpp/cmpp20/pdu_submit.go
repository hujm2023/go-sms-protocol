...
func (p *PduSubmit) GetHeader() cmpp.Header {
	return p.Header
}
...
func (p *PduSubmit) GetCommandID() cmpp.CommandID {
	return cmpp.CommandSubmit
}

func (p *PduSubmit) NewHeader(seqID uint32) cmpp.Header {
	return cmpp.NewHeader(MaxSubmitLength, cmpp.CommandSubmit, seqID)
}

func (p *PduSubmit) GenerateResponseHeader() protocol.PDU {
	resp := &PduSubmitResp{
		Header: cmpp.NewHeader(MaxSubmitRespLength, cmpp.CommandSubmitResp, p.GetSequenceID()),
	}
	return resp
}
...
func (pr *PduSubmitResp) IEncode() ([]byte, error) {
	...
	b.WriteBytes(pr.GetHeader().Bytes())
...
func (pr *PduSubmitResp) GetHeader() cmpp.Header {
	return pr.Header
}
...
func (pr *PduSubmitResp) GetCommandID() cmpp.CommandID {
	return cmpp.CommandSubmitResp
}

func (pr *PduSubmitResp) NewHeader(seqID uint32) cmpp.Header {
	return cmpp.NewHeader(MaxSubmitRespLength, cmpp.CommandSubmitResp, seqID)
}

func (pr *PduSubmitResp) GenerateResponseHeader() protocol.PDU {
	return nil
}
...
func (pr *PduSubmitResp) MaxLength() uint32 {
	return MaxSubmitRespLength
}
